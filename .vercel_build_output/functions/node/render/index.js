...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-c4233086.js",
      css: ["/./_app/assets/start-a8cd1609.css"],
      js: ["/./_app/start-c4233086.js", "/./_app/chunks/vendor-dc4178ae.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "/./_app/layout.svelte-36f2602c.js", "css": [], "js": ["/./_app/layout.svelte-36f2602c.js", "/./_app/chunks/vendor-dc4178ae.js"], "styles": null }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-a9dd49ff.js", "css": [], "js": ["/./_app/error.svelte-a9dd49ff.js", "/./_app/chunks/vendor-dc4178ae.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-eb3c0cbf.js", "css": ["/./_app/assets/pages/index.svelte-114ccbb0.css"], "js": ["/./_app/pages/index.svelte-eb3c0cbf.js", "/./_app/chunks/vendor-dc4178ae.js"], "styles": null } };
...
create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"card svelte-1umli0k"}"><img src="${"src/assets/" + escape2(cardType) + "/" + escape2(card) + ".svg"}" class="${escape2(cardType) + "-" + escape2(card) + " svelte-1umli0k"}"${add_attribute("alt", card, 0)}>
</div>`;
});
...
var CardPile = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"card-pile-container"}"><ul class="${"card-pile svelte-2z6wvm"}"><img src="${"src/assets/minicards/back.svg"}" alt="${"backs"}" class="${"card svelte-2z6wvm"}">
        <img src="${"src/assets/minicards/back.svg"}" alt="${"back"}" class="${"card svelte-2z6wvm"}">
        <img src="${"src/assets/minicards/back.svg"}" alt="${"back"}" class="${"card svelte-2z6wvm"}"></ul>
</div>`;
});
var css = {
